...
let s:crimson = [ '#DC143C', 160 ]
let s:magenta = [ '#f2c68a', 216 ]
let s:blue = [ '#8ac6f2', 117 ]
let s:cyan = s:blue
let s:white = [ '#ffffff', 255 ]
let s:black = [ '#000000', 0 ]
let s:midnightblue = [ '#191970', 4]
let s:green = [ '#95e454', 119 ]
let s:p = {'normal': {}, 'inactive': {}, 'insert': {}, 'replace': {}, 'visual': {}, 'tabline': {}}
let s:p.normal.left = [ [ s:base02, s:blue ], [ s:base3, s:base01 ] ]
" 下の改造版　適用するなら，replace/insert/normal/virtualも替えないといけないから面倒
"let s:p.normal.left = [ [ s:base02, s:blue ], [ s:black, s:base3 ] ]
" 一番右の色  []内はそれぞれ，[fg(文字), bg(back)]の組み合わせ
...
" tabsel: 現在選択タブ
let s:p.tabline.left = [ [ s:black, s:base3 ] ]
